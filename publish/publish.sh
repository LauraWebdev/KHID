...
APP_URN_ROOT="media.laura"
APP_URN="$APP_URN_ROOT.$APP_NAME_LCD"

APP_MAINTAINER="Laura Sofia Heimann <hello@laura.media>"
APP_DESC_SHORT="KHInsider Downloader"
APP_DESC_LONG="KHID is an easy to use cross-platform KHInsider downloader"

# Set project options
PROJECT_NAME="KHID.UI"
PROJECT_ROOT=$(pwd)/..
